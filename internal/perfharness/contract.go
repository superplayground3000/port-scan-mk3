...
func DefaultContract() Contract {
	fixtures := []FixtureSpec{
		...
		{Family: FamilySnapshotHeavy, Shape: "chunk-heavy", Scale: Scale{TargetBytes: 100_000_000}, Seed: DefaultGeneratorSeed},
		{Family: FamilySnapshotHeavy, Shape: "port-heavy", Scale: Scale{TargetBytes: 100_000_000}, Seed: DefaultGeneratorSeed},
