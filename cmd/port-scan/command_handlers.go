...
func usage(w io.Writer) {
	...
	fmt.Fprintln(w, "")
	fmt.Fprintln(w, "port-scan scan -cidr-file <file> -resume <bucket-file> [-target-count-limit N] [-target-memory-limit-gb N] [-output <file>] [-timeout 100ms] [-workers N] [-delay 10ms] [-bucket-rate N] [-bucket-capacity N] [-disable-api] [-pressure-api URL] [-pressure-interval 5s] [-pressure-auth-url URL] [-pressure-data-url URLs] [-pressure-client-id ID] [-pressure-client-secret SECRET] [-pressure-use-auth] [-progress-interval N] [-cidr-ip-col ip] [-cidr-ip-cidr-col ip_cidr] [-log-level info] [-format human|json] [-quiet]")
