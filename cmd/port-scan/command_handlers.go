...
func usage(w io.Writer) {
	...
	fmt.Fprintln(w, "")
	fmt.Fprintln(w, "port-scan pre-ping -cidr-file <file> [-target-count-limit N] [-target-memory-limit-gb N] [-pre-scan-ping-timeout 100ms] [-workers N] [-output <file>] [-progress-interval N] [-cidr-ip-col ip] [-cidr-ip-cidr-col ip_cidr] [-log-level info] [-format human|json] [-quiet]")
	...
	fmt.Fprintln(w, "")
	fmt.Fprintln(w, "port-scan generate-buckets -cidr-file <file> -buckets-out <file> [-target-count-limit N] [-target-memory-limit-gb N] [-port-file <file>] [-unreachable-file <file>] [-workers N] [-progress-interval N] [-cidr-ip-col ip] [-cidr-ip-cidr-col ip_cidr] [-log-level info] [-format human|json] [-quiet]")
	fmt.Fprintln(w, "    Build a resume bucket snapshot over targets minus the optional -unreachable-file blocklist. No network I/O.")
	fmt.Fprintln(w, "")
	fmt.Fprintln(w, "port-scan scan -cidr-file <file> -resume <bucket-file> [-target-count-limit N] [-target-memory-limit-gb N] [-output <file>] [-output-flush-results N] [-timeout 100ms] [-workers N] [-delay 10ms] [-bucket-rate N] [-bucket-capacity N] [-disable-api] [-pressure-api URL] [-pressure-interval 5s] [-pressure-auth-url URL] [-pressure-data-url URLs] [-pressure-client-id ID] [-pressure-client-secret SECRET] [-pressure-use-auth] [-progress-interval N] [-cidr-ip-col ip] [-cidr-ip-cidr-col ip_cidr] [-log-level info] [-format human|json] [-quiet]")
	...
	fmt.Fprintln(w, "")
	fmt.Fprintln(w, "port-scan validate -cidr-file <file> [-port-file <file>] [-target-count-limit N] [-target-memory-limit-gb N] [-format human|json]")
